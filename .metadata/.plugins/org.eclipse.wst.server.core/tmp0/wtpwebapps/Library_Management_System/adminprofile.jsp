                              ...
                              <div class="row">
                                  ...
                                  <div class="hexagon-item">
                                          ...
                                          <div class="hexagon-item">
                                              ...
                                              <a  class="hex-content" href="addbook.jsp">
                                                  <span class="hex-content-inner">
                                                      <span class="icon">
                                           ...
                                           <div class="hexagon-item">
                                              ...
                                              <a  class="hex-content" href="editFindBook.jsp">
                                                  <span class="hex-content-inner">
                                                      <span class="icon">
                                                          <i class="fa fa-clipboard"></i>
                                                      </span>
                                    ...
                                    <div class="container d-flex justify-content-center align-items-center">
                                        <div class="card">
                                            ...
                                            <div class="mt-5 text-center">
                                                <h4 class="mb-0">Admin ${cus.username }</h4> <span class="text-muted d-block mb-2">${cus.email }</span>
