                          ...
                          <div class="container">
                              <div class="row">
                                  <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                      ...
                                      <h1>Edit Book</h1>
                                      <form action="searchEditBook" method="post">
										<input type="search" name="search" class="form-control rounded" placeholder="Search">
										<input type="submit" name="submit" value="find" class="btn btn-outline-primary">
										</form>
                                      </div><br><br>
										...
										<c:forEach var = "cus3" items="${find}">
											<tr class="paddingstyle2">
												<td style="padding: 10px;">
                                                	...
                                                	<img src="data:image/png;base64,${cus3.base64Image}" width="280" height="400" alt="image">
                                            	</td>
                                            	<th style="padding: 40px;">
                                            	<h1>Book edit</h1>
                                            	<form action="bookEdit" method="post">
                                            		<p style="color: red;">**Please don't change book code**</p>
                                            		<input type="text" name="code" value="${cus3.code}">
                                            		<input type="text" name="title" value="${cus3.title}" class="styleTextss" style="font-weight: bold;">
                                            		<input type="text" name="author" value="${cus3.author}" class="styleTextss">
                                            		<p class="imageBook">${cus3.description} </p>
