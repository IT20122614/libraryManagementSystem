...
<br><br>
    <center>
        <div>
            ...
            <span class="heading-page" id="homeWord"> Reading is dreaming with open eyes</span>
        </div>
                              ...
                              <div class="row">
                                      ...
                                      <div class="hexagon-menu clear">
                                          ...
                                          <div class="hexagon-item">
                                              ...
                                              <a  class="hex-content" href="login.jsp">
                                                  <span class="hex-content-inner">
                                                      <span class="icon">
                                          ...
                                          <div class="hexagon-item">
                                              ...
                                              <a  class="hex-content" href="signup.jsp">
                                                  <span class="hex-content-inner">
                                                      <span class="icon">
                                          ...
                                          <div class="hexagon-item">
                                              ...
                                              <a  class="hex-content" href="aboutUs.jsp">
                                                  <span class="hex-content-inner">
                                                      <span class="icon">
